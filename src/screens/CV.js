        ...
        <div className={classes.cvContainer}>
            ...
            <div className={classes.divContenu}>
                ...
                <div className={classes.title}>
                    ...
                    <Step year="Décembre 2019 - Aujourd'hui" name="Altran - Ingénieur d'études et développement" place={Texts.altran} />
                    <Step year="Mars 2019 - Décembre 2019" name="BigInt - Product Owner" place={Texts.bigInt} />
